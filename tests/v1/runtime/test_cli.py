...
from mplang.v1.runtime.cli import (
    load_config,
...
def test_status_command_success():
    ...
    try:
        ...
        with patch(
            "mplang.v1.runtime.cli.HttpExecutorClient", return_value=mock_client
        ):
            # Create mock args
            args = MagicMock()
...
def test_status_command_unhealthy_node():
    ...
    try:
        ...
        with patch(
            "mplang.v1.runtime.cli.HttpExecutorClient",
...
def test_start_command_success():
    ...
    try:
        ...
        with patch("mplang.v1.runtime.cli.run_server") as mock_run_server:
            # Create mock args
            args = MagicMock()
            args.config = config_path
            args.node_id = "P0"
...
def test_start_cluster_command_success():
    ...
    try:
        ...
        with patch(
            "mplang.v1.runtime.cli.multiprocessing.Process"
