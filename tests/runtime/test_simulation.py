...
class TestComplexCond:
    ...
    def test_rank_based_conditional(self, simulator, trace_context):
        ...
        def rank_based_func():
            ...
            """
            r = prank()
            is_one = mp.rjax(lambda v: v == 1, r)  # bool per-party
            ...
            result = mp.rjax(jnp.where, is_one, val_then, val_else)
            return result
    ...
    def test_nested_conditional_with_rank(self, simulator, trace_context):
        ...
        def two_level_func():
            ...
            """
            r = prank()
            pred1 = mp.rjax(lambda v: v == 1, r)  # per-party bool
            ...
            combined = mp.rjax(jnp.where, pred1, val0, val1)
            return combined
    ...
    def test_cond_with_jax_functions_basic(self, simulator, trace_context):
        ...
        def cond_with_jax():
            ...
            pred = mp.rjax(lambda v: v == 1, prank())
            ...
            def then_fn(val):
                return mp.rjax(square_plus_one, val)

            def else_fn(val):
                return mp.rjax(multiply_and_add, val)

            # Evaluate both, elementwise select
            t_res = then_fn(input_data)
            f_res = else_fn(input_data)
            return mp.rjax(jnp.where, pred, t_res, f_res)
    ...
    def test_cond_with_captured_variables(self, simulator, trace_context):
        ...
        def cond_with_capture():
            ...
            def then_fn(input_val):
                return mp.rjax(matrix_op, input_val, outer_matrix)

            def else_fn(input_val):
                return mp.rjax(element_op, input_val, outer_vector)
    ...
    def test_cond_with_neural_network_simulation(self, simulator, trace_context):
        ...
        def neural_network_cond():
            ...
            def then_fn(input_val):
                return mp.rjax(forward_pass, input_val, weights, bias)

            def else_fn(input_val):
                return mp.rjax(statistical_transform, input_val, weights)
    ...
    def test_cond_with_optimizer_simulation(self, simulator, trace_context):
        ...
        def optimizer_cond():
            ...
            def adam_optimizer(grad, lr, mom, eps, state):
                return mp.rjax(adam_step, grad, lr, mom, eps, state)

            def sgd_optimizer(grad, lr, mom, eps, state):
                # Only use first two parameters for SGD
                return mp.rjax(sgd_step, grad, lr)
            ...
            return mp.rjax(jnp.where, pred, adam_res, sgd_res)
...
class TestWhileLoop:
    ...
    def test_while_loop_expression_generation(self, trace_context):
        ...
        def while_func():
            ...
            def cond_fn(x):
                ...
                return mp.rjax(lambda a, b: a < b, x, counter_max)

            def body_fn(x):
                # Captures increment from outer scope
                return mp.rjax(lambda a, b: a + b, x, increment)
    ...
    def test_rank_based_termination(self, simulator, trace_context):
        ...
        def rank_loop():
            ...
            def cond_fn(counter):
                ...
                return mp.rjax(check, counter, rank)
            ...
            def body_fn(counter):
                ...
                return mp.rjax(increment, counter)
    ...
    def test_array_accumulation_loop(self, simulator, trace_context):
        ...
        def accumulation_loop():
            ...
            def cond_fn(state):
                ...
                return mp.rjax(check_sum, state, threshold)
            ...
            def body_fn(state):
                ...
                return mp.rjax(add_increment, state, increment)
        ...
        def complex_capture_loop():
            ...
            def create_condition():
                ...
                def cond_fn(x):
                    ...
                    return mp.rjax(check, x, max_value, threshold)
            ...
            def create_body():
                ...
                def body_fn(x):
                    ...
                    return mp.rjax(transform, x, multiplier, step)
    ...
    def test_accumulation_loop(self, simulator, trace_context):
        ...
        def accumulation_loop():
            ...
            def body_fn(state):
                ...
                return mp.rjax(accumulate_squares, state)
    ...
    def test_rank_dependent_termination(self, simulator, trace_context):
        ...
        def rank_dependent_loop():
            ...
            def cond_fn(state):
                ...
                return mp.rjax(check_limit, state, rank)
            ...
            def body_fn(state):
                ...
                return mp.rjax(transform, state, rank)
    ...
    def test_matrix_transformation_loop(self, simulator, trace_context):
        ...
        def matrix_loop():
            ...
            def cond_fn(matrix):
                ...
                return mp.rjax(check_trace, matrix, threshold)
            ...
            def body_fn(matrix):
                ...
                return mp.rjax(transform_matrix, matrix)
    ...
    def test_early_termination_with_capture(self, simulator, trace_context):
        ...
        def early_termination_loop():
            ...
            def cond_fn(counter):
                ...
                return mp.rjax(should_continue, counter, max_iterations, rank)
            ...
            def body_fn(counter):
                ...
                return mp.rjax(increment_by_step, counter, step_size)
    ...
    def test_while_loop_subset_state_mask(self):
        ...
        def subset_loop():
            ...
            def cond_fn(state):
                subset_pred = mp.rjax(lambda val, limit: val < limit, state, threshold)
                return pshfl_s(subset_pred, full_mask, [Rank(0), Rank(0), Rank(0)])

            def body_fn(state):
                return mp.rjax(lambda val, inc: val + inc, state, step)
    ...
    def test_while_loop_subset_context_mask_success(self):
        ...
        def subset_loop():
            ...
            def cond_fn(state):
                ...
                return mp.rjax(lambda val, limit: val < limit, state, threshold)
    ...
    def test_while_loop_cond_body_with_aux_party(self):
        ...
        def cooperative_loop():
            ...
            def cond_fn(states):
                ...
                _ = mp.rjax(lambda val, inc: val + inc, aux_val, aux_step)
                subset_pred = mp.rjax(
            ...
            def body_fn(states):
                ...
                next_sub = mp.rjax(lambda val, step: val + step, sub_val, subset_step)
                next_aux = mp.rjax(lambda val, inc: val + inc, aux_val, aux_step)
    ...
    def test_nested_while_with_conditional(self, simulator, trace_context):
        ...
        def nested_while_cond():
            ...
            def cond_fn(state):
                ...
                return mp.rjax(check_target, state, target)

            def body_fn(state):
                # Use conditional logic based on current state value
                even_check = mp.rjax(lambda x: x % 2 == 0, state)

                def then_fn(val):
                    # If even: multiply by 2
                    return mp.rjax(lambda x: x * 2, val)

                def else_fn(val):
                    # If odd: add 3
                    return mp.rjax(lambda x: x + 3, val)
...
class TestPShflS:
    ...
    def test_different_source_mapping(self, simulator, trace_context):
        ...
        def cross_shuffle():
            ...
            multiplied_data = mp.rjax(lambda x: x * 10 + 100, rank_data)
    ...
    def test_same_rank_mapping(self, simulator, trace_context):
        ...
        def same_source_shuffle():
            ...
            rank = prank()
            unique_data = mp.rjax(lambda r: (r + 1) * 100, rank)
    ...
    def test_shuffle_with_computation(self, simulator, trace_context):
        ...
        def computation_shuffle():
            ...
            rank = prank()
            initial_data = mp.rjax(lambda r: r * 5 + 10, rank)
            ...
            final_result = mp.rjax(lambda x: x * 2 + 1, shuffled_data)
    ...
    def test_shuffle_chain(self, simulator, trace_context):
        ...
        def shuffle_chain():
            # Initial data
            rank = prank()
            initial = mp.rjax(lambda r: (r + 1) * 10, rank)
            ...
            transformed = mp.rjax(lambda x: x + 5, first_shuffle)
    ...
    def test_shuffle_with_conditional(self, simulator, trace_context):
        ...
        def conditional_shuffle():
            ...
            rank = prank()
            pred = mp.rjax(lambda r: r == 0, rank)
            ...
            t_val = then_fn(rank)
            f_val = else_fn(rank)
            cond_result = mp.rjax(jnp.where, pred, t_val, f_val)
