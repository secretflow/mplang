...
Usage:
    ...
    python -m mplang.v2.backends.cli up --world-size 3 --base-port 8100

    # Or with a config file
    python -m mplang.v2.backends.cli up -c cluster.yaml
"""
...
Examples:
  ...
  python -m mplang.v2.backends.cli up -w 3 -p 8100 --spu-base-port 9100

  # Start workers from config file
  python -m mplang.v2.backends.cli up -c examples/conf/3pc.yaml
        """,
    )
