...
Usage:
    ...
    python -m mplang.cli sim -f examples/v2/psi_bench.py --profile

    # Via CLI (distributed HTTP cluster)
    python -m mplang.cli run -c cluster.yaml -f examples/v2/psi_bench.py
...
def __mp_main__(*args: str) -> dict[str, Any]:
    ...
    from mplang.libs.mpc.psi import rr22
