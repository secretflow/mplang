...
Example:
    >>> from mplang2.libs.collective import transfer, replicate, distribute, collect
    >>> from mplang2.dialects.simp import constant, converge
    >>>
...
from mplang2.dialects.simp import converge, shuffle_static
from mplang2.edsl import Object
