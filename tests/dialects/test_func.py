    ...
    expected_ir = dedent(
        """\
            (%arg0: Tensor[f32, ()], %arg1: Tensor[f32, ()]) {
              %0 = func.func() {in_imms=[], in_morph=(PyTreeDef(((*, *), {})), (0, 1)), out_imms=[], out_morph=(PyTreeDef({'nested': (*, {'orig': *}), 'sum': *}), (0, 1, 2)), output_types=[Tensor[f32, ()], Tensor[f32, ()], Tensor[f32, ()]], sym_name='_complex_body'} : Custom[function] {
                (%arg0: Tensor[f32, ()], %arg1: Tensor[f32, ()]) {
