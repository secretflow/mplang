...
from mplang2.edsl.graph import Graph, Operation
from mplang2.edsl.printer import GraphPrinter, format_graph
from mplang2.edsl.typing import Tensor, f32, i32


def _add_constant(graph: Graph, value, type):
    """Helper to add constant to graph (for testing only)."""
...
def test_graph_printer_with_regions():
    ...
    zero = _add_constant(else_graph, 0.0, f32)
